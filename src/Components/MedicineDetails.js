...
const MedicineDetails = ({ match }) => {
  // Utilisez les paramètres d'URL pour obtenir l'ID du médicament sélectionné
  const { id } = match.params;

  // Ici, vous pouvez utiliser l'ID pour récupérer les détails du médicament de votre backend ou de votre état local
